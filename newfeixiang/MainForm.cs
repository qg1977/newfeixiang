    ...
    public partial class MainForm : Form
    {
        ...
        void MenuClicked(object sender, EventArgs e)
        {
            try
            {
                ...
                string form_name_add = "newfeixiang." + form_name;


                int index =a_sqlconn.other.HaveOpened(this, form_name);
                if (index == -1)
                {
                    ObjectHandle t = null;
                    try
                    {
                        t = Activator.CreateInstance("newfeixiang", form_name_add);
        ...
        private void 更改密码_Click(object sender, EventArgs e)
        {
            try
            {
                int index = a_sqlconn.other.HaveOpened(this, "passs");
                if (index == -1)
                {
